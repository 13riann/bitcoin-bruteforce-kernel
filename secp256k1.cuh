...
// ============================================================================
// Header-only pattern: one TU defines, others declare.
#ifdef DEFINE_SECP256K1_CONSTANTS
__device__ __constant__ BigInt      const_p;
__device__ __constant__ ECPointJac  const_G_jacobian;
__device__ __constant__ BigInt      const_n;
#else
extern __device__ __constant__ BigInt      const_p;
extern __device__ __constant__ ECPointJac  const_G_jacobian;
extern __device__ __constant__ BigInt      const_n;
#endif
